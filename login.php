		...
		<div class="lgi_mainBody">
			...
			<div class="lgi_form">
				<form id="login" name="login" method="post" action="login2.php">
					<ul>
						<li><input type="tel" name="tel" class="" placeholder="你的手机号/邮箱"/></li>
						<li><input type="password" name="password" class="" placeholder="密码"/></li>
						<li><input type="text" name="yanzhengma" class="yzm" placeholder="验证码" /> <img /></li>
						<li><input type="checkbox" name="remember me" class="rm" /> <div class="rmt">记住我</div> <div class="notme">不是自己的电脑上不要勾选此项</div> <a href="#" >忘记密码？</a></li>
						<li><input type="submit" name"login" class="login" value="登录"><a href="register.php" class="register">注册</a></li>
						<li><a href="management/login.php" class="notme" style="float: left;">管理员登录</a></li>
					</ul>
				</form>
			</div>
