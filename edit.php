...
<html>
	...
	<body>
		...
		<div class="rgt_mainBody">
			<div class="login_text"><?php echo $row[0]; ?>您好</div>
			<!--分割线*2-->
			<div class="rgt_line1" style="width: 350px;"></div>
			<div class="rgt_line2" style="width: 350px;"></div>
			
			<form class="rgt_form" method="post" id="edit" name="edit" action="edit2.php" enctype="multipart/form-data">
				<ul>
					<li><input type="text" name="ed_username" class="" placeholder="新昵称" /></li>
					<li><input type="password" name="ed_password1" class="" placeholder="新密码(6-16个字符组成区分大小写)" /></li>
					<li><input type="password" name="ed_password2" class="" placeholder="确认新密码(6-16个字符组成区分大小写)" /></li>
					<li>
						<select class="slc_country" name="ed_adress">
						...
						<input type="tel" name="ed_tel" class="in_phone_nub" placeholder="新手机号" />
					</li>
					<a href="#" style="float: right;margin-top: 10px;">用邮箱注册></a>
					<!--<li class="yzm">
						<a href="#" >请上传头像(仅.jpg)</a>
						<input type="file" name="ed_head" id="ed_head" value="" />
					</li>-->
					<div class="xieyi">
					...
					<li>
						<input type="submit" name="rgt_sbm" class="rgt_sbm" value="修改"/>
					</li>
				</ul>
			</form>
